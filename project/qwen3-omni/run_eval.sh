...
#
# 用法示例:
#   RESULT_PATH=project/qwen3-omni/infer_results/result_v1_lora_checkpoint-1000_xxx.jsonl bash run_eval.sh
#   bash run_eval.sh RESULT_PATH=project/qwen3-omni/infer_results/result_xxx.jsonl TARGET_CLASS=song
...
if [ -z "${RESULT_PATH:-}" ]; then
    ...
    echo "        示例: bash $0 RESULT_PATH=project/qwen3-omni/infer_results/result_xxx.jsonl" >&2
    echo "        或:   RESULT_PATH=project/qwen3-omni/infer_results/result_xxx.jsonl bash $0" >&2
    exit 1
fi
